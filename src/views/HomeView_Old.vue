        ...
        <section class="final-de-pagina">
            ...
            <div class="boton-final">
                <div class="borde-esquina-invertido">
                    <a class="line" href="/proyectos">Todos los proyectos</a>
                </div>
            </div>
        </section>
        ...
        <section id="contactos" class="contactos">
            ...
            <div class="imagen-correo ocultar">
                ...
                <div class="texto-correo">
                    <div>
                        <a class="line" href="mailto:colocho.yessenia@gmail.com">Colocho.Yessenia@gmail.com</a>
                    </div>

                    <div>
                        <a class="line" href="https://www.linkedin.com/in/yessenia-colocho-330654160/" target="_blank"> Linkedin /
                            Yessenia Colocho</a>
                    </div>
